...
/* ── File Item ── */
function FileItem({ file, isActive, onClick, textColor, accent, depth, canEdit, startRename, renamingPath, renameValue, setRenameValue, renameInputRef, handleRenameSubmit, onDelete }) {
  const [isHovered, setIsHovered] = useState(false)
